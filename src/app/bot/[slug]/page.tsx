  ...
  return (
    <div className="min-h-screen bg-[#030303] font-sans text-[#e8e8e8]">
      <div className="max-w-[1180px] mx-auto px-6 pt-6 pb-20">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8">
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="text-white font-black text-[38px] tracking-[-0.03em] m-0 leading-none mb-3">
                {bot.name}
              </h1>
              ...
              <div className="flex flex-wrap items-center gap-3">
                <div className={`px-2.5 py-1 rounded text-[9px] font-mono font-bold tracking-widest uppercase border ${hasVerifiedPerformance ? 'bg-[#c8ff00]/10 text-[#c8ff00] border-[#c8ff00]/30' : 'bg-[#222] text-[#666] border-[#333]'}`}>
                  {hasVerifiedPerformance ? '✓ Verified Performance' : 'Pending Performance'}
                </div>
                <div className={`px-2.5 py-1 rounded text-[9px] font-mono font-bold tracking-widest uppercase border ${hasVerifiedReputation ? 'bg-[#c8ff00]/10 text-[#c8ff00] border-[#c8ff00]/30' : 'bg-[#222] text-[#666] border-[#333]'}`}>
                  {hasVerifiedReputation ? '✓ Verified Reputation' : 'Reputation < 0'}
                </div>
              </div>
            </div>
          </div>
        ...
        {bot.description && <p className="text-[14px] leading-relaxed text-[#9a9a9a] mb-10 max-w-3xl whitespace-pre-wrap">{bot.description}</p>}
        ...
        <div className="rounded-2xl border border-[#1a1a1a] bg-[#080809] overflow-hidden mb-8">
          <div className="flex flex-col sm:flex-row items-stretch">
            ...
            <div className="flex-1 p-6 flex flex-col justify-between min-w-0">
              ...
              <div className="mt-5 grid grid-cols-2 gap-4 border-t border-[#141420] pt-4">
                {[
